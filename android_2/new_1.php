        ...
        if ($action == 'delete') {
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                <script>
                    ...
                    window.location.href = 'new_1.php';
                </script>
                ";
            } else {
...
<div class="container mx-auto p-6">
    <h2 class="text-3xl font-bold mb-6 text-center">USERS</h2>
        ...
        <table class="min-w-full border-collapse">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    ...
                    <th class="py-3 px-6 border-b text-left">age</th>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr class='hover:bg-gray-100'>
                            ...
                            <td class='py-3 px-6 border-b'>".$row['mobile']."</td>
                            <td class='py-3 px-6 border-b'>".$row['email']."</td>
                            <td class='py-3 px-6 border-b'>".$row['age']."</td>
