...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['id']) && isset($_POST['action'])) {
        ...
        if ($action == 'delete') {
            ...
            $sql_fetch = "SELECT username, userphonenumber FROM request WHERE id = $id";
            ...
            if ($result_fetch->num_rows > 0) {
                ...
                // Check if they exist in the register table
                ...
                // Now delete the request from the request table
                $sql_delete_request = "DELETE FROM request WHERE id = $id";
                ...
                echo "<script>alert('No matching request found.');</script>";
            }
        } else {
            echo "Invalid action.";
        }
...
<div class="container mx-auto p-6">
    <h2 class="text-3xl font-bold mb-6 text-center">USER REQUESTS</h2>
            ...
            <tbody class="text-gray-600 text-sm font-light">
                ...
                if ($result->num_rows > 0) {
                    ...
                    <form action='' method='POST'>
                        ...
                        <button type='submit' name='action' value='delete' class='border border-gray-300 rounded-md bg-red-500 text-white px-4 py-2'>Delete</button>
                    </form>
                </td>
                        </tr>";
                    }
