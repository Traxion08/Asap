...
if (isset($_POST["name"]) && isset($_POST["phonenumber"]) && isset($_POST["email"]) && 
    isset($_POST["vehiclenumber"]) && isset($_POST["password"]) && isset($_FILES['filename'])) {
    ...
    if (move_uploaded_file($tempName, $uploadPath)) {
        ...
        $q = "INSERT INTO ambulance_register (name, phonenumber, email, vehiclenumber, photo, password) 
              VALUES ('$name', '$phonenumber', '$email', '$vehiclenumber', '$originalImgName', '$password')";
