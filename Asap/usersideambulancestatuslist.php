...
$stmt = $con->prepare( "SELECT id,username,userphonenumber,drivername,driverphonenumber,vehiclenumber,request_time,status FROM request WHERE userphonenumber='$userphonenumber' ");
